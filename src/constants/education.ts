...
export const EDUCATION: TimelineInterface[] = [
    ...
    },
    {
        ...
        description: "The certification “Certified Tech Developer” is a two-year course designed by Mercado Libre and Globant together with Digital House, where technical knowledge and fundamental soft skills are obtained.",
        buttons: [
            {
                label: "Syllabus",
